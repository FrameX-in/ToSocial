      ...
      <div class="flex items-center justify-center w-full lg:p-9 ">
        <div class="flex items-center p-3  ">
          <form class="flex flex-col w-full h-full pb-6 text-center bg-white rounded-3xl">
            ...
            <a class="flex items-center justify-center w-full py-4 mb-6 text-sm font-medium transition duration-300 rounded-2xl text-gray-900 bg-gray-200 hover:bg-gray-300 focus:ring-4 focus:ring-gray-200 cursor-pointer">
