    ...
    <div class="text-center">
      <div
        ...
        <form className=" flex items-center justify-center opacity-100 ml-3">
          ...
          <input type="text " className='w-[40%]  bg-transparent placeholder-gray-500 dark:placeholder-white rounded-e-md  py-2 shadow-[2px_5px_8px_2px_#00000024]'  placeholder='username'/>
